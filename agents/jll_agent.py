...
agents/jll_agent.py
--------------------
Daily agent: fetches new JLL APAC research publications.
...
Run manually:  python agents/jll_agent.py
...
SEARCH_QUERIES = [
    "JLL Asia Pacific real estate research report 2026",
    "JLL Japan office logistics research 2026",
    "JLL Korea Seoul office market report 2026",
    "JLL Singapore office industrial research 2026",
    "JLL Australia commercial real estate report 2026",
    "JLL Hong Kong office market report 2026",
    "site:jll.com/research Asia Pacific 2026",
]
...
CRITICAL: Only include publications whose URL comes from an official company website (jll.com, research.jllapsites.com, and country-specific jll.com.* / jll.co.* domains). Do NOT include sources from LinkedIn, Facebook, YouTube, Scribd, news sites, aggregators (realestateasia.com, itiger.com, etc.), or any third-party domain. If the only source for a publication is a third-party URL, omit that publication entirely.
...
def main():
    ...
    print("\n" + "="*50)
    print(f" JLL Agent — {date.today().isoformat()}")
    print("="*50)
