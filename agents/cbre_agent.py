...
CRITICAL: Only include publications whose URL comes from an official company website (cbre.com, cbre.com.au, cbre.com.hk, cbre.com.sg, cbre.co.jp, cbrekorea.com, cbre.co.kr, cbrevietnam.com). Do NOT include sources from LinkedIn, Facebook, YouTube, Scribd, news sites, aggregators (realestateasia.com, itiger.com, etc.), or any third-party domain. If the only source for a publication is a third-party URL, omit that publication entirely.
